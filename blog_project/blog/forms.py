...
class SearchForm(forms.Form):
    search = forms.CharField(widget=forms.TextInput(attrs={"required": "required","type":"search","class":
        "search-text","placeholder":"请输入想搜索的内容...","autocomplete":"off"}),
                             max_length=30,error_messages={"required":"输入的值不能为空",})
